...
Shader "PicoTanks/SquashAndStretchNormals"
{
	Properties
	{
		...
		_Deviation("Deviation", Range( 0.01 , 1)) = 0.1
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 break49_g30 = ase_vertex3Pos;
			...
			float3 newPos307 = appendResult75_g30;
			...
			float3 break49_g28 = mul( ( appendResult276 + mul( ObjectToTangent269, ase_vertex3Pos ) ), ObjectToTangent269 );
			float xPos52_g28 = break49_g28.x;
			float yPos50_g28 = break49_g28.y;
			float temp_output_22_0_g28 = ( 1.0 - ( ( sin( ( ( ( abs( yPos50_g28 ) / ( Radius329 / ase_objectScale.x ) ) * ( 0.5 * UNITY_PI ) ) - ( 0.5 * UNITY_PI ) ) ) + 1 ) / 2 ) );
			float SquashInput77_g28 = Squash328;
			float clampResult18_g28 = clamp( SquashInput77_g28 , -10 , 1 );
			float Squas23_g28 = clampResult18_g28;
			float lerpResult41_g28 = lerp( 1 , ( ( 1.0 - ( temp_output_22_0_g28 * StretchCurve333 ) ) * StretchEffect332 ) , ( atan( ( abs( Squas23_g28 ) * 2 ) ) / ( 0.5 * UNITY_PI ) ));
			float StretchMultiplierXZZ45_g28 = lerpResult41_g28;
			float lerpResult38_g28 = lerp( 0 , ( SquashEffect330 * ( 1.0 - ( SquashCurve331 * temp_output_22_0_g28 ) ) ) , Squas23_g28);
			float SquashMultiplierXZZ43_g28 = ( lerpResult38_g28 + 1 );
			float clampResult66_g28 = clamp( ( ( Squas23_g28 * 1000 ) + 0.5 ) , 0 , 1 );
			float lerpResult69_g28 = lerp( StretchMultiplierXZZ45_g28 , SquashMultiplierXZZ43_g28 , clampResult66_g28);
			float SquashMultiplierYY47_g28 = ( ( 1.0 - Squas23_g28 ) * yPos50_g28 );
			float zPos51_g28 = break49_g28.z;
			float3 appendResult75_g28 = (fixed3(( xPos52_g28 * lerpResult69_g28 ) , SquashMultiplierYY47_g28 , ( zPos51_g28 * lerpResult69_g28 )));
			float3 yDeviation308 = appendResult75_g28;
...
/*ASEBEGIN
Version=15203
2567;29;2546;1374;5989.859;-115.2916;2.833156;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;265;-4160.55,2071.364;Float;False;Property;_Deviation;Deviation;7;0;Create;True;0;0;False;0;0.1;0.1;0.01;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;337;-2723.91,3507.335;Float;False;SquashAndStretch;-1;;28;f8d354f41350d51489ee32fd0240afc5;0;7;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;3;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;327;-3425.377,1427.949;Float;False;SquashAndStretch;-1;;30;f8d354f41350d51489ee32fd0240afc5;0;7;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;3;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=DC18CB9B42023A3C408A2FA8556B813FC60ED88E