...
Shader "PicoTanks/SquashAndStretch"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 break49_g24 = ase_vertex3Pos;
			float xPos52_g24 = break49_g24.x;
			float yPos50_g24 = break49_g24.y;
			float Radius329 = _Radius;
			float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
			float temp_output_22_0_g24 = ( 1.0 - ( ( sin( ( ( ( abs( yPos50_g24 ) / ( Radius329 / ase_objectScale.x ) ) * ( 0.5 * UNITY_PI ) ) - ( 0.5 * UNITY_PI ) ) ) + 1 ) / 2 ) );
			float StretchCurve333 = _StretchCurve;
			float StretchEffect332 = _StretchEffect;
			float Squash328 = _Squash;
			float SquashInput77_g24 = Squash328;
			float clampResult18_g24 = clamp( SquashInput77_g24 , -10 , 1 );
			float Squas23_g24 = clampResult18_g24;
			float lerpResult41_g24 = lerp( 1 , ( ( 1.0 - ( temp_output_22_0_g24 * StretchCurve333 ) ) * StretchEffect332 ) , ( atan( ( abs( Squas23_g24 ) * 2 ) ) / ( 0.5 * UNITY_PI ) ));
			float StretchMultiplierXZZ45_g24 = lerpResult41_g24;
			float SquashEffect330 = _SquashEffect;
			float SquashCurve331 = _SquashCurve;
			float lerpResult38_g24 = lerp( 0 , ( SquashEffect330 * ( 1.0 - ( SquashCurve331 * temp_output_22_0_g24 ) ) ) , Squas23_g24);
			float SquashMultiplierXZZ43_g24 = ( lerpResult38_g24 + 1 );
			float clampResult66_g24 = clamp( ( ( Squas23_g24 * 1000 ) + 0.5 ) , 0 , 1 );
			float lerpResult69_g24 = lerp( StretchMultiplierXZZ45_g24 , SquashMultiplierXZZ43_g24 , clampResult66_g24);
			float SquashMultiplierYY47_g24 = ( ( 1.0 - Squas23_g24 ) * yPos50_g24 );
			float zPos51_g24 = break49_g24.z;
			float3 appendResult75_g24 = (fixed3(( xPos52_g24 * lerpResult69_g24 ) , SquashMultiplierYY47_g24 , ( zPos51_g24 * lerpResult69_g24 )));
			v.vertex.xyz = appendResult75_g24;
		}
...
/*ASEBEGIN
Version=15203
2567;29;2546;1374;2579.105;-1038.801;1.178151;True;False
...
Node;AmplifyShaderEditor.FunctionNode;327;-886.8337,1760.4;Float;False;SquashAndStretch;-1;;24;f8d354f41350d51489ee32fd0240afc5;0;7;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;3;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-157.6772,1402.696;Fixed;False;True;2;Fixed;ASEMaterialInspector;0;0;Unlit;PicoTanks/SquashAndStretch;False;False;False;False;True;True;True;True;True;True;True;True;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;0;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;0;4;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Absolute;0;;-1;-1;-1;-1;0;0;0;False;0;0;0;False;-1;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;0;11;327;0
ASEEND*/
//CHKSM=7FA0F82136DA87CFD1E6953428C4B3F96027DAC7